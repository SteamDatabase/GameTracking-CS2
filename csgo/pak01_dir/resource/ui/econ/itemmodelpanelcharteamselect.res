"Resource/UI/Econ/ItemModelPanelCharMainMenu.res"
{
	"mainmenu_player-model"
	{
		...
		"config"
		{
			...
			// T -- 1
			"camera_preset_add"   "pos[99.91 -59.64 53.40] pivot[0.00 1.91 54.80] orient[-0.68 148.37 0.00] fov[45.0]"

			// CT -- 2
			"camera_preset_add"   "pos[100.60 62.20 58.56] pivot[-0.00 1.89 54.79] orient[1.84 -149.06 0.00] fov[45.0]"
