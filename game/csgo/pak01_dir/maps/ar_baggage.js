...
{
    return { dir: ConvDir, pow: ConvPow };
} );
Instance.OnReload(conv =>
{
    ConvDir = conv?.dir || false;
    ConvPow = conv?.pow || false;
} );
...
Instance.OnScriptInput( "TogglePow", () =>
{
...
Instance.OnScriptInput( "StopLightLoop", () =>
{
	if ( bLooping == false )
		return;
